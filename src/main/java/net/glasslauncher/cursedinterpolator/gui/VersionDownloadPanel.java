...
public class VersionDownloadPanel extends JDialog {
    ...
    public VersionDownloadPanel(JFrame parent, String basePath) {
        super(parent);
        setModal(true);
